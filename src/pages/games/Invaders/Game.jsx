...
export default class Game extends Scene {
    ...
    preload ()
    {
        this.load.spritesheet('invader', '../../../assets/animations/invaders/invader1.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('boom', '../../../animations/invaders/explosion.png', { frameWidth: 64, frameHeight: 64, endFrame: 23 });
    }
